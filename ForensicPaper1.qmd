...
[![Metrics of selected citation as of 15-Feb-2025](images/AJSM Metrics.png)](https://journals.sagepub.com/doi/10.1177/0363546506296042)
...
This paper has been put through the wringer by countless SR-MA of graft type in ACL reconstruction. Let's do a quick summary of what others have said about the methods through RoB or methodology assessments in previous reviews.
...
One systematic review [@janssen2017] used the Cochrane library checklist for RCTs, with two reviewers conducting independent ratings. Interestingly, the authors classified this trial as a *clinical controlled trial* (no formal randomisation) rather than a *randomised controlled trial*. The overall rating from the combined checklist score was *Questionable (*score was between 30% and 50%).

A more recent review [@sollberger2022] attempted to assess long term results after ACLR with PT vs HS autograft with a min follow up of 10 years, but did not include this paper.
