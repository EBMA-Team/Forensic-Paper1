...
The burning question remains how this paper is being cited in the contemporary literature, what is the sentiment of this paper?

```{r}

CitationRecent <- Citations |> dplyr::select(
  year,
  DO
) |> dplyr::filter(
  year > 2022
...
<!--# Not PRO-specific, unless the PROs were used in eligibilityor stratification criteria -->
