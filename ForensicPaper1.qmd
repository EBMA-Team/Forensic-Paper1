...
You can review the abstract for this paper [here](https://journals.sagepub.com/doi/10.1177/0363546506296042). In brief, this was an attempted RCT comparing two sources of graft material forreconstructing the anterior cruciate ligament in patients participating in high levels of competitive sport at the time of injury. The selected citation is the 10-year follow up of the comparison between groups, with previous reports at 2, 5 and 7 year follow ups (see Trial Protocol).
...
Plugged into the *rsprite2* functions gives and error that *the mean is not consistent with number of observations (fails GRIM test)*.
...
AgeDistPT_Param <- set_parameters(
  mean = 26.244, 
  sd = 5.855, 
  n_obs = 90, 
  min_val = 13,
